...
(function() {
  ...
  Revert.prototype.insert = function(dataitem, done) {
  ...
  Revert.prototype.remove = function(dataitem, done) {
  ...
  Revert.prototype.update = function(dataitem, done) {
    var collection, findparams, reinserts;
    collection = dataitem.collection;
    findparams = dataitem.args["0"];
    reinserts = null;
  ...
  Revert.prototype.findAndModify = function(dataitem, done) {
