...
(function() {
  var Fixture, Revert, async, fs, util;
    ...
    return async.whilst((function(_this) {
      ...
      return function(next) {
        ...
        switch (dataitem.method) {
          case "insert":
            return _this.revert.restoreInsert(dataitem, next);
          case "update":
            return _this.revert.restoreUpdate(dataitem, next);
          case "remove":
            return _this.revert.restoreRemove(dataitem, next);
          case "findAndModify":
            return _this.revert.restoreFindAndModify(dataitem, next);
        }
      };
    })(this), done);
  };
