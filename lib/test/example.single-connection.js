...
(function() {
  ...
  describe("Person model", function() {
    ...
    it("should delete multiple stuff", function(done) {
      var finds, opts;
      finds = {
        _id: {
      ...
      return mongoose.models.Person.remove(finds, function(err, numAffected) {
        if (err) {
          throw err;
        }
        return mongoose.models.Person.find({}, function(err, people) {
    ...
    it("should reset multiple deletion stuff", function(done) {
      return mongoose.models.Person.find({}, function(err, people) {
        expect(people).to.have.length(4);
        return done();
      });
